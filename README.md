...
```bash
pip install aa-timezones==3.2.1
```
...
[![Translation status](https://weblate.ppfeufer.de/widget/alliance-auth-apps/aa-timezones/matrix-auto.svg)](https://weblate.ppfeufer.de/engage/alliance-auth-apps/)
