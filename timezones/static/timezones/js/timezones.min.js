...
function updatePanels(a){updatePanel(moment(a),"loc");jQuery.each(timezoneOptions,function(c,b){updatePanel(moment.tz(a,b.timezoneName),b.timezoneId)})}function clockTick(){updatePanels(new Date)}
